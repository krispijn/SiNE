...
public class JNrTextField extends JTextField
{
    ...
    public JNrTextField( int maxLen )
    {
        this( maxLen, DECIMAL );
    }

    public JNrTextField( int maxLen, int format )
    {
    ...
    {
        if (getText() != null && !getText().isEmpty() && !getText().trim().isEmpty()) {
